      ...
      <section className="relative grid grid-cols-1 lg:grid-cols-2 items-center justify-between w-full mx-auto px-5 md:px-10 lg:px-20 py-20 lg:py-40 gap-5">
        ...
        <div className="order-2 lg:order-1 w-full flex-col items-center space-y-6 text-center lg:items-start lg:text-left">
          ...
          <div className="flex flex-row items-center justify-center lg:justify-start gap-5">
            ...
            <a
              href="#contact"
              className="inline-flex items-center justify-center rounded-full border border-amber-500 px-6 py-3 text-sm font-semibold text-amber-500 transition  hover:bg-white hover:text-black"
            >
              Contactez-nous
            </a>
          </div>
        ...
        {/* Image */}
        <div className="order-1 lg:order-2 w-full rounded-2xl overflow-hidden ">
          <img
            src={heroImg} alt="Hero illustration" className="w-full h-full object-cover"
          />
        </div>
      </section>
    </BgHeroProps>
